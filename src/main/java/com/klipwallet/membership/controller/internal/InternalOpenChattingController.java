...
@RestController
@RequestMapping("/internal/v1/open-chattings")
...
public class InternalOpenChattingController {
    ...
    public OpenChattingStatus getOpenChattingStatus(
            ...
            @Parameter(description = "klaytn address", required = true,
                       example = "0xa9a95c5fef43830d5d67156a2582a2e793acb465") @RequestParam Address klaytnAddress) {

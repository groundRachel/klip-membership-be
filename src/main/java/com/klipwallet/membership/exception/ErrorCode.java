...
public enum ErrorCode {
    ...
    HOST_OPEN_CHATTING_LIMIT_EXCEEDED(400_008),
    ...
    OPERATOR_INVITATION_EXPIRED(410_002),
    OPERATOR_INVITATION_CODE_EXPIRED(410_003),
    OPERATOR_ALREADY_JOINED(409_003),
    OPERATOR_INVITATION_NOT_MATCHED(400_007),
    OPERATOR_INVITEE_NOT_EXISTS_ON_KLIP(400_009),
    HOST_NOT_FOUND(404_013),
    OPERATOR_INVITEE_ALREADY_JOINED(400_011),
    ...
    KAS_NOTFOUND_INTERNAL_API_ERROR(500_201),
    KAS_BADREQUEST_INTERNAL_API_ERROR(500_202),
    KAKAO_BADREQUEST_INTERNAL_API_ERROR(500_203),
    KAKAO_FORBIDDEN_INTERNAL_API_ERROR(500_204),

    // Klip Drops
    KLIP_DROPS_PARTNER_NOT_FOUND_BY_BUSINESS_NUMBER(404_011),
    KLIP_DROPS_PARTNER_NOT_FOUND(404_012),
    KLIP_DROPS_PARTNER_DO_NOT_MATCH_PARNTER_APPLICATION_BUSINESS_NUMBER(400_010),

    // OpenChatting
    OPEN_CHATTING_ACCESS_DENIED(403_001),
    OPEN_CHATTING_NOT_FOUND(404_014),
    OPEN_CHATTING_NFT_NOT_FOUND(404_015);

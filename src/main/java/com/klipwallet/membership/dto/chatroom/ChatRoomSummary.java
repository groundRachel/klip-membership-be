...
public record ChatRoomSummary(@Schema(description = "채팅방 ID", type = "string", example = "1") Long id,
                              @Schema(description = "카카오 오픈채팅방 ID", example = "302067190") Long openChatRoomId,
                              @Schema(description = "카카오 오픈채팅방 URL", example = "https://open.kakao.com/o/gvJWpNBf") String openChatRoomUrl,
